...
Java_com_commonlauncher_nativeplugin_MaliOptNative_isFenceSyncSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)check_egl_extension("EGL_KHR_fence_sync");
}

JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isNativeFenceSyncSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)check_egl_extension("EGL_ANDROID_native_fence_sync");
}

JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isWaitSyncSupported(JNIEnv *env, jobject thiz) {
