...
static void detect_context(void) {
    ...
    while (fgets(line, sizeof(line), maps)) {
        if (strstr(line, "libgl4es")) {
            strcpy(g_context, "GL4ES"); fclose(maps); return;
        }
        if (strstr(line, "libEGL_angle") || strstr(line, "libGLESv2_angle")) {
            strcpy(g_context, "ANGLE"); fclose(maps); return;
        }
    }
    fclose(maps);
...
Java_com_commonlauncher_nativeplugin_MaliOptNative_detectExtensions(JNIEnv *env, jobject thiz) {
    if (g_initialized) return;
    LOGI("========== MaliOpt: Iniciando deteccao ==========");
    detect_context();
    ...
    g_initialized = true;
    LOGI("========== MaliOpt: Deteccao concluida ==========");
}

JNIEXPORT jstring JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getExtensionReport(JNIEnv *env, jobject thiz) {
    if (!g_initialized)
...
JNIEXPORT jstring JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getRawGLExtensions(JNIEnv *env, jobject thiz) {
    return (*env)->NewStringUTF(env, g_raw_gl_ext); }
JNIEXPORT jstring JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getRawEGLExtensions(JNIEnv *env, jobject thiz) {
    return (*env)->NewStringUTF(env, g_raw_egl_ext); }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isFramebufferFetchSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.FB_FETCH; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isFramebufferFetchDepthStencilSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.FB_FETCH_DEPTH_STENCIL; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isPLSSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.PLS; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isMaliBinarySupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.MALI_BINARY; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isASTCLDRSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.ASTC_LDR; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isASTCHDRSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.ASTC_HDR; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isETC2Supported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.ETC2; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isStandardDerivativesSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.STANDARD_DERIVATIVES; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isTextureFloatSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.TEXTURE_FLOAT; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isTextureFloatLinearSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.TEXTURE_FLOAT_LINEAR; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isTextureHalfFloatSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.TEXTURE_HALF_FLOAT; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isTextureHalfFloatLinearSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.TEXTURE_HALF_FLOAT_LINEAR; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isMultisampledRTSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.MULTISAMPLED_RT; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isMultisampledRT2Supported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.MULTISAMPLED_RT2; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isSRGBSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.SRGB; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isSRGBWriteControlSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.SRGB_WRITE_CONTROL; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isAnisotropicFilteringSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.ANISOTROPIC; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isProgramBinarySupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.PROGRAM_BINARY; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isTextureStorageSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.TEXTURE_STORAGE; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isTextureNPOTSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.TEXTURE_NPOT; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isMapBufferSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.MAP_BUFFER; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isBufferStorageSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.BUFFER_STORAGE; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isTimerQuerySupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.TIMER_QUERY; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isDebugMarkerSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.DEBUG_MARKER; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isKHRDebugSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.KHR_DEBUG; }
JNIEXPORT jboolean JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_isRobustnessSupported(JNIEnv *env, jobject thiz) {
    return (jboolean)g_caps.ROBUSTNESS; }
JNIEXPORT jint JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getMaxTextureSize(JNIEnv *env, jobject thiz) {
    return (jint)g_caps.MAX_TEXTURE_SIZE; }
JNIEXPORT jint JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getMaxSamples(JNIEnv *env, jobject thiz) {
    return (jint)g_caps.MAX_SAMPLES; }
JNIEXPORT jint JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getMaxAnisotropy(JNIEnv *env, jobject thiz) {
    return (jint)g_caps.MAX_ANISOTROPY; }
JNIEXPORT jint JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getMaxVertexAttribs(JNIEnv *env, jobject thiz) {
    return (jint)g_caps.MAX_VERTEX_ATTRIBS; }
JNIEXPORT jint JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getMaxCombinedTextureImageUnits(JNIEnv *env, jobject thiz) {
    return (jint)g_caps.MAX_COMBINED_TIU; }
JNIEXPORT jstring JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getActiveRenderContext(JNIEnv *env, jobject thiz) {
    return (*env)->NewStringUTF(env, g_context); }
JNIEXPORT jstring JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getGPURenderer(JNIEnv *env, jobject thiz) {
    return (*env)->NewStringUTF(env, g_caps.GPU_RENDERER); }
JNIEXPORT jstring JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getGPUVendor(JNIEnv *env, jobject thiz) {
    return (*env)->NewStringUTF(env, g_caps.GPU_VENDOR); }
JNIEXPORT jstring JNICALL
Java_com_commonlauncher_nativeplugin_MaliOptNative_getGLESVersion(JNIEnv *env, jobject thiz) {
